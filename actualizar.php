            ...
            <div class="container-fluid">
                ...
                <form class='form-control ' method="post">
                    <div>
                        ...
                        <input name="productName" type="text" class="form-control col-9" id="productName" pattern="^(?!\s*$).+" value="Aquí debe ir el nombre del producto" required />
                    </div>
                    <div>
                        <label for="price" class="form-label col-3">Precio</label>
                        <!-- Sustituye el atributo value por el recuperado de BD -->
                        <input name="price" type="number" step="0.01" class="form-control col-9" id="price" required value="0.00" />
                    </div>
